  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-r from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="flex flex-1 relative">
        ...
        {/* Sidebar */}
        <div 
          className={`fixed inset-y-0 right-0 transform ${sidebarOpen ? 'translate-x-0' : 'translate-x-full'} w-64 bg-white dark:bg-gray-800 shadow-lg transition-transform duration-300 ease-in-out z-20 flex flex-col pt-16`}
        >
          <div className="p-4 flex-1 flex flex-col gap-4">
            <h2 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-4">Menu</h2>
            <button
